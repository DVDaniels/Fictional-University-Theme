...
<header class="site-header">
      <div class="container">
        <h1 class="school-logo-text float-left">
          <a href="<?php echo site_url() ?>"><strong>Daniels</strong> Web Design</a>
        </h1>
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            <ul>
              ...
              <li <?php if (get_post_type() == 'campus') ?>><a href="<?php echo get_post_type_archive_link('campus'); ?>">Campuses</a></li>
